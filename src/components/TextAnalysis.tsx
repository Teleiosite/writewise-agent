...
export function TextAnalysis() {
  ...
  return (
    <Card className="p-4 relative overflow-hidden group/analysis">
      {/* Absolute Close Button for Wide Space Toggle */}
      <Button 
        variant="ghost" 
        size="icon" 
        className="absolute top-2 right-2 h-7 w-7 rounded-full text-gray-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 z-10 opacity-60 hover:opacity-100 transition-all active:scale-90"
