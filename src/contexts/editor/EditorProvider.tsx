  ...
  return (
    <EditorContext.Provider
      value={{
        ...
        showLeftSidebar: panelManager.showLeftSidebar,
        showRightSidebar: panelManager.showRightSidebar,
        activeAiTab: panelManager.activeAiTab,
        aiTriggerToken: panelManager.aiTriggerToken,
        ...
        toggleLeftSidebar: panelManager.toggleLeftSidebar,
        toggleRightSidebar: panelManager.toggleRightSidebar,
        setActiveAiTab: panelManager.setActiveAiTab,
        triggerAiAction: panelManager.triggerAiAction,
